...
[Web服务器BOA](https://worktile.com/kb/ask/1460322.html)是一种轻量级的HTTP服务器软件，它专门针对嵌入式设备和资源有限的系统进行设计和优化。下面将从BOA的特点、功能和适用场景三个方面来介绍BOA。
...
[嵌入式web boa配置流程详解](https://blog.csdn.net/qq_44333320/article/details/134195283)

[CGI脚本](https://blog.csdn.net/weixin_43044226/article/details/125512807)

**CGI脚本是什么？**CGI脚本简单地讲是个运行在Web服务器上的程序, 有浏览器的输入触发. 这个脚本通常象服务器和系统中其他程序如数据库的桥梁。CGI 脚本难道不是一个真正的脚本?按照你的服务器的支持, 他们可能是一个编译好的程序或者批命令文件或者其他可执行的东西
