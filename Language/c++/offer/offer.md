...
8. [TCP的三次握手和四次挥手](https://blog.51cto.com/jinlong/2065461)
...
11. [TCP连接和关闭的状态转移](https://blog.51cto.com/jinlong/2065461)
...
12. TCP慢启动
    ...
    - TCP要求发送方必须有两个窗口：接收窗口rwnd（接收方许诺发送方的窗口字段），拥塞窗口cwnd（发送方自身估算的拥塞程度而设置的窗口值），发送窗口的上限值 = min{ rwnd，cwnd}
